...
- **OG:Image fallback**: Added a default Open Graph image (`/images/email-cover.jpg`) in the root layout metadata and as a fallback for blog posts that lack a cover image.
...
- Verify `/images/email-cover.jpg` exists and is approximately 1200x630 pixels.
