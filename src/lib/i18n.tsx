...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    dataAnalyticsDesc: 'Modern data stacks, pipelines, and dashboards that turn raw information into insight.',
    dataAnalyticsCard: 'Warehouses, ETL, visualization, insights.',
    cloudDevops: 'Cloud & DevOps',
    cloudDevopsDesc: 'Automated infrastructure, CI/CD, and security for reliable, cost-efficient cloud operations.',
    ...
    aiAutomationDesc: 'LLM-powered agents and workflow automation that accelerate your teams.',
    aiAutomationCard: 'LLMs, agents, workflow automation.',
    automationQa: 'Automation & QA',
    automationQaDesc: 'Automate processes and testing to deliver quality software faster.',
    automationQaCard: 'Workflow automation and testing.',
    appsApis: 'Apps & APIs',
    appsApisDesc: 'Scalable web and mobile apps backed by clean, secure APIs.',
    appsApisCard: 'From prototype to production.',
    itConsulting: 'IT Consulting',
    itConsultingDesc: 'Strategic guidance aligning architecture and roadmaps with business goals.',
  ...
  es: {
    ...
    dataAnalyticsDesc: 'Plataformas modernas, pipelines y dashboards en tiempo real que convierten datos crudos en insights.',
    dataAnalyticsCard: 'Almacenes, ETL, visualización e insights.',
    cloudDevops: 'Nube y DevOps',
    cloudDevopsDesc: 'Infraestructura automatizada, CI/CD y seguridad para operar con fiabilidad y costo eficiente en la nube.',
    ...
    aiAutomationDesc: 'Agentes y automatización impulsados por LLM que aceleran a tus equipos.',
    aiAutomationCard: 'LLMs, agentes, automatización de flujos.',
    automationQa: 'Automatización y QA',
    automationQaDesc: 'Automatizamos procesos y pruebas para entregar software de calidad más rápido.',
    automationQaCard: 'Automatización de flujos y pruebas.',
    appsApis: 'Apps y APIs',
    appsApisDesc: 'Aplicaciones web y móviles escalables con APIs limpias y seguras.',
    appsApisCard: 'Del prototipo a la producción.',
    itConsulting: 'Consultoría IT',
    itConsultingDesc: 'Asesoría estratégica que alinea arquitectura y roadmaps con los objetivos del negocio.',
